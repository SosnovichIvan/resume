...
export const profile: Profile = {
  name: "Соснович Иван",
  position: "Frontend Developer — React, Next.js, NestJS",
  location: "Красногорск (Московская область) · удалённо",
  about:
    "Руководитель группы фронтенд-разработки с опытом 5+ лет. Проектирую архитектуру приложений, перевожу проекты на FSD, добиваюсь покрытия тестами 90%+ и стабильной работы высоконагруженных интерфейсов.",
  aboutFull: [
    ...
    "Руковожу командами до 3 разработчиков: код-ревью, наставничество, груминг задач, планирование спринтов, проведение собеседований.",
  ...
  highlights: ["Опыт 5+ лет", "Team Lead", "FSD-архитектура", "Удалённо"],
};
